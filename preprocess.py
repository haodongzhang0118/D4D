...
if __name__ == "__main__":
    ...
    parser.add_argument('--train_dir1', type=str, help='Directory for train images')
    parser.add_argument('--train_dir2', type=str, help='Directory for valid images')
    ...
    train_dir = args.train_dir1
    val_dir = args.train_dir2
